...
class u_noise(object):
    x_rel = 0.12 # x noise (relative) in percent (0.01 = 1%)
    ...
    theta_rel = 0.05 # heading noise (relative) in percent (0.01 = 1%)
    theta_abs = 0.035 # heading noise (absolute) in radians

### MEASUREMENT MODEL PARAMETERS:
class z_noise(object):
    r_rel = 0.12 # range noise (relative) in percent (0.01 = 1%)
    r_abs = 0.12 # range noise (absolute) in meters
    b_rel = 0.05 # bearing noise (relative) in percent (0.01 = 1%)
    b_abs = 0.035 # bearing noise (absolute) in radians
